...
//        try {
//            List<WarCron> list = taskService.selectByExample();
...
//        if(id!=null){
//            WarCron task = taskService.searchbyid(id);
//            modelMap.addAttribute("task",task);
//        }else {
//            modelMap.addAttribute("task",new WarCron());
//        }
...
//    @RequestMapping("/add")
//    @ResponseBody
//    public Object addSupplier(WarCron task){
//        try {
//
...
////    @ResponseBody
////    public Object editSupplier(WarCron task){
////        try {
...
////    @ResponseBody
////    public Object deleteById(String id,WarCron task){
////        try {
