  ...
  BEGIN
    ...
    l_sqlBuf := "SELECT A.TZZH_ID,
                    ...
                    FROM (SELECT TZZH_ID,
                                 ...
                                 SUM(YSSL) AS YSSL,
                                 SUM(CASE
                                       WHEN JYLB IN ('1', '59', '61', '41', '80', '83', '93', '94','3') OR
                                 ...
                                 SUM(CASE
                                     ...
                                     END) AS MRSL,
                                 SUM(CASE
                                       WHEN ZQLB = 'L0' and JYLB = '81' THEN  /*2卖出,6分红,17兑付,22兑息,43赎回,45分红,71融资强平,81退保*/
                                        0
                                       WHEN JYLB IN
                                            ('2', '6', '17', '22', '45', '60', '62', '71', '81', '76') OR
    ...
    l_sqlBuf := "SELECT A.TZZH_ID,
                    ...
                    FROM (SELECT B.TZZH_ID,
                                 ...
                                 ROUND(SUM(CASE
                                               ...
                                               WHEN ((JYLB IN
                                                 ('15', '18', '47', '48') AND
                                                   NOT (B.ZQLB = 'L0' AND B.JYS = '2' AND B.JYLB = '18' AND
                                                   B.CJBH = '份额变动')) OR (JYLB IN ('29','30') AND IS_ETFHB=0)) AND YSSL > 0 THEN
                                                  ABS(B.YSSL * A.ZXJ)
                ...
                "                                   AND NOT (JYLB='19' AND B.ZQLB='Z6' AND B.JYS='2' AND B.CJBH='非交易过户') " ||
                "                                   AND YSSL < 0 THEN" ||
                "                              ABS(B.YSSL * A.ZXJ)" ||
